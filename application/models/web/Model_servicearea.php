...
class Model_servicearea extends CI_Model {
...
function getContentChl($row_id,$label_id)
    ...
    {
            $where ="where a.districts_name LIKE '%$address%' or b.city_name LIKE '%$address%' or c.province_name LIKE '%$address%' ";
         $sql   = "SELECT distinct a.districts_id FROM tbl_districts as a
                    INNER JOIN tbl_city as b on a.city_id = b.city_id
                    INNER JOIN tbl_province as c on b.province_id=c.province_id ". $where ;
