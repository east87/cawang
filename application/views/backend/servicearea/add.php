                  ...
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/'.$controller.'/doAdd'; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     ...
                     <div class="m-portlet__body">
                      <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-3">
                               <select class="form-control m-input" name="province_id" id="province_id" required="">
                                 <option value="">----</option>
                            ...
                            <select class="form-control m-input" name="city_id" id="city_id" required="">
                                <option value="0" selected="">Select City Name</option>
                            </select> 
                            </div>
                            <div class="col-lg-3 districts" style="">
                            <select class="form-control m-input" name="districts_id" id="districts_id" required="">
                                <option value="" selected="">Select Distrik Name</option>
                            </select> 
                            </div>
                        </div>
