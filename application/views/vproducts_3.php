...
<html class="no-js" lang="en">
    <head>
        <!-- title -->
        <title>AC 1 PK | Dingin Lebih Cepat</title>
        <meta charset="utf-8">
  ...
  <?php include 'include/analytics.php';?>
    ...
    <body>
       ...
       <div class="dropdownleft">
        <button class="dropbtn text-uppercase"> <i class="ti-angle-double-down"></i> <span>1 PK (9000 BTU/H)</span></button>
       ...
       <section id="home" class="p-0 inner-match-height md-no-padding-bottom cover-background" data-stellar-background-ratio="0.5" style="background-image:url('<?= IMAGES_BASE_URL;?>/family_room_web.jpg');">
