...
<html class="no-js" lang="en">
    ...
    <body>
       ...
       <div class="dropdownleft">
        <button class="dropbtn text-uppercase"> <i class="ti-menu-alt"></i> <span>Pilih AC</span></button>
        <div class="dropdown-content">
        <a href="<?= BASE_URL?>/Products" title="">1/2PK (5000 BTU/H)</a>
        <a href="<?= BASE_URL?>/Products" title="">3/4PK (7000 BTU/H)</a>
        <a href="<?= BASE_URL?>/Products" title="">1 PK (9000 BTU/H)</a>
        <a href="<?= BASE_URL?>/Products" title="">1 1/2 PK (12000 BTU/H)</a>
        </div>
      </div>
        </div>
            ...
            <div class="container">
                <div class="row col-lg-8 offset-lg-2 col-xs-12 offset-0">
                    <div class="col-3 col-xs-12 text-center sm-margin-ten-bottom wow zoomIn" data-wow-delay="0.2s">
                        <a href="#dingin_cepat" title="dingin cepat" class="icon-medium margin-25px-bottom sm-margin-15px-bottom">
                    ...
                    <div class="col-3 col-xs-12 text-center sm-margin-ten-bottom wow zoomIn" data-wow-delay="0.4s">
                      <a href="#r32" title="r32" class="icon-medium margin-25px-bottom sm-margin-15px-bottom">
                     ...
                     <div class="col-3 col-xs-12 text-center sm-margin-ten-bottom wow zoomIn" data-wow-delay="0.6s">
                      <a href="#hemat_energi" title="hemat_energi" class="icon-medium margin-25px-bottom sm-margin-15px-bottom">
                    ...
                    <div class="col-3 col-xs-12 text-center sm-margin-ten-bottom wow zoomIn" data-wow-delay="0.8s">
                      <a href="#sni" title="sni" class="sm-margin-10px-bottom">
